 ...
 * @LastEditTime: 2024-05-07 00:02:29
...
use crate::controller::{
    ...
    index_controller, moment_controller, user_controller,
};
...
pub async fn run(conf: &'static Config) -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            //admin
            .service(web::scope("/admin/").default_service(web::to(adminIndexController::default)))
