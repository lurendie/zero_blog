...
// use crate::utils::ip_value::ToUIntIP;
...
// fn load_file() -> Vec<u8> {
//     let xdb_filepath = std::env::var("./data/ip2region.xdb")
//         .unwrap_or_else(|_| default_detect_xdb_file().unwrap());
//     log::debug!("load xdb searcher file at {} ", xdb_filepath);
...
//         let ip_str = search_by_ip("2.0.0.0").unwrap();
//         println!("{ip_str}");
